...
from .views import BulkCreateSchoolDayClassView, SchoolClassList, SchoolDayList, SchoolDayRange, SchoolDayRangeWithClasses, SchoolYearDetail, SchoolYearList
...
urlpatterns = [
    ...
    path('days_range_with_classes/<str:school_year_id>/', SchoolDayRangeWithClasses.as_view(), name='school_day_range'),
