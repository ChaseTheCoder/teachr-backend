...
from .views import DomainBulkPost, DomainList, GradeLevelsList, IssuingAuthorityList, IssuingAuthorityDetail, StandardList, SubjectList
...
urlpatterns = [
    ...
    path('standards/<str:pk>/', StandardList.as_view()),
]